...
-- DIRE_BOUNTY_RUNE_OFF = Vector(3485.0, 295.0, 384.0) --- Original
-- DIRE_BOUNTY_RUNE_SAFE = Vector(-2825.0, 4150.0, 384.0) --- Original
-- RAD_BOUNTY_RUNE_SAFE = Vector(1295.0, -4120.0, 384.0) --- Original
-- RAD_BOUNTY_RUNE_OFF = Vector(-4350.0, 200.0, 256.0) --- Original
-- POWERUP_RUNE_TOP = Vector(-1755.0, 1205.0, 128.0) --- Original
-- POWERUP_RUNE_BOT = Vector(2620.0, -2000.0, 128.0) --- Original
-- DIRE_SHRINE_OFF =  Vector(4200.0, -1575.0, 384.0) --- Original
-- DIRE_SHRINE_SAFE = Vector(-125.0, 2550.0, 384.0) --- Original
-- RAD_SHRINE_SAFE = Vector(635.0, -2550.0, 384.0) --- Original
-- RAD_SHRINE_OFF =  Vector(-4225.0, 1275.0, 384.0) --- Original
...
POWERUP_RUNE_TOP = Vector(-1640.0, 1112.0, 48.0)
POWERUP_RUNE_BOT = Vector(1180.0, -1216.0, 64.0)
