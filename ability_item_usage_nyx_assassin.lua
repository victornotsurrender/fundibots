...
function ConsiderOverwhelmingOdds()
	...
	if ( mutil.IsPushing(npcBot) or  mutil.IsDefending(npcBot) or npcBot:GetActiveMode() == BOT_MODE_LANING) and currManaP > 0.45 and  abilityOO:GetLevel() > 1
	then
...
function ConsiderUnBorrow()
	...
	if npcBot:HasModifier("modifier_item_dustofappearance") and ( tableNearbyAlliedHeroes ~= nil and tableNearbyEnemyHeroes ~= nil and #tableNearbyAlliedHeroes == 0 and #tableNearbyEnemyHeroes >= 2) 
