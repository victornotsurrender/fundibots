...
function AbilityUsageThink()
	...
	if asMorphling == false then
		...
		if ( (skill1 ~= nil and skill1:IsNull() == false and skill1:IsFullyCastable() == false) or
		     (skill2 ~= nil and skill2:IsNull() == false and skill2:IsFullyCastable() == false) or
...
function ConsiderFireblast()
	...
	if (npcBot:GetActiveMode() == BOT_MODE_LANING or mutil.IsPushing(npcBot) or mutil.IsDefending(npcBot) ) and abilityFB:GetLevel () >= 3 and currManaP > 0.80
	then
